...
use PSW\Cinema\Core\Core;
use PSW\Cinema\Core\Exceptions\Handler;
use PSW\Cinema\Core\Facades\Core as CoreFacade;
...
class CoreServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        ...
        Validator::extend('slug', 'PSW\Cinema\Core\Contracts\Validations\Slug@passes');

        Validator::extend('code', 'PSW\Cinema\Core\Contracts\Validations\Code@passes');

        Validator::extend('decimal', 'PSW\Cinema\Core\Contracts\Validations\Decimal@passes');
