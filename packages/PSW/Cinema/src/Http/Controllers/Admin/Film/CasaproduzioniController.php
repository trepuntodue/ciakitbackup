...
use PSW\Cinema\DataGrids\CasaproduzioniDataGrid;
use Webkul\Admin\Http\Controllers\Controller;
use Webkul\Core\Repositories\ChannelRepository;
use Illuminate\Support\Facades\DB;
use PSW\Cinema\Film\Repositories\CasaproduzioniRepository;

class CasaproduzioniController extends Controller
{
    /**
     ...
     *
     * @param \PSW\Cinema\Film\Repositories\CasaproduzioniRepository  $casaproduzioniRepository
     */
    public function __construct(
       protected CasaproduzioniRepository $casaproduzioniRepository 
        )
    {
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            return app(CasaproduzioniDataGrid::class)->toJson();
        }
    ...
    public function create()
    {
        ...
        $casaproduzioni = DB::table('casaproduzione')->orderBy('casa_nome', 'asc')->get();
     //echo '<pre>';print_r($casaproduzioni);  
        return view($this->_config['view'], compact('casaproduzioni'));
    }
    ...
    public function store(Request $req)
    {
        ...
        // die();
       // $data['casaproduzioni_nome_cognome']=$data['casaproduzioni_nome'].' '.$data['casaproduzioni_cognome'].' '.$data['casaproduzioni_alias'];
        if ($this->casaproduzioniRepository->create($data)) {
            session()->flash('success', trans('admin::app.cinema.casaproduzione.create-success'));
           return redirect()->route($this->_config['redirect']);
        }
            session()->flash('error', trans('admin::app.cinema.casaproduzione.create-error'));        
    ...
    public function edit($id)
    {
        ...
        $casaproduzioni=$this->casaproduzioniRepository->findOneByField('id',$id);
    ...
    public function update($id)
    {
      ...
      //  $data['casaproduzioni_nome_cognome']=$data['casaproduzioni_nome'].' '.$data['casaproduzioni_cognome'].' '.$data['casaproduzioni_alias'];
        ...
        $this->casaproduzioniRepository->update($data, $id);

        session()->flash('success', trans('admin::app.cinema.casaproduzione.update-success'));
    ...
    public function destroy($id)
    {
        ...
        try {
            $this->casaproduzioniRepository->delete($id);
