...
use PSW\Cinema\DataGrids\GenereDataGrid;
use Webkul\Admin\Http\Controllers\Controller;
use Webkul\Core\Repositories\ChannelRepository;
use Illuminate\Support\Facades\DB;
use PSW\Cinema\Film\Repositories\GeneriRepository;
...
class GeneriController extends Controller
{
     ...
     *
     * @param \PSW\Cinema\Film\Repositories\GeneriRepository  $generiRepository
     */
    public function __construct(
       protected GeneriRepository $generiRepository 
        )
    {
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            return app(GenereDataGrid::class)->toJson();
        }
    ...
    public function create()
    {
        ...
        $generi = DB::table('generi')->orderBy('generi_name', 'asc')->get();
       // echo '<pre>';print_r($generi);  
        return view($this->_config['view'], compact('generi'));
    }
    ...
    public function store(Request $req)
    {
        ...
        //die();
        if ($this->generiRepository->create($data)) {
            session()->flash('success', trans('admin::app.cinema.genere.create-success'));
           return redirect()->route($this->_config['redirect']);
        }
            session()->flash('error', trans('admin::app.cinema.genere.create-error'));        
    ...
    public function edit($id)
    {
        ...
        $generi=$this->generiRepository->findOneByField('id',$id);
    ...
    public function update($id)
    {
        ...
        $this->generiRepository->update($data, $id);

        session()->flash('success', trans('admin::app.cinema.genere.update-success'));
    ...
    public function destroy($id)
    {
        ...
        try {
            $this->generiRepository->delete($id);
