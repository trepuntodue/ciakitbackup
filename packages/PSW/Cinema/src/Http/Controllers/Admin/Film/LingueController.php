...
use PSW\Cinema\DataGrids\LingueDataGrid;
use Webkul\Admin\Http\Controllers\Controller;
use Webkul\Core\Repositories\ChannelRepository;
use Illuminate\Support\Facades\DB;
use PSW\Cinema\Film\Repositories\LingueRepository;
...
class LingueController extends Controller
{
     ...
     *
     * @param \PSW\Cinema\Film\Repositories\LingueRepository  $lingueRepository
     */
    public function __construct(
       protected LingueRepository $lingueRepository 
        )
    {
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            return app(LingueDataGrid::class)->toJson();
        }
    ...
    public function create()
    {
        ...
        $lingue = DB::table('language')->orderBy('id', 'asc')->get();
       // echo '<pre>';print_r($lingue);  
        return view($this->_config['view'], compact('lingue'));
    }
    ...
    public function store(Request $req)
    {
        ...
        //die();
        if ($this->lingueRepository->create($data)) {
            session()->flash('success', trans('admin::app.cinema.lingua.create-success'));
           return redirect()->route($this->_config['redirect']);
        }
            session()->flash('error', trans('admin::app.cinema.lingua.create-error'));        
    ...
    public function edit($id)
    {
        ...
        $lingue=$this->lingueRepository->findOneByField('id',$id);
    ...
    public function update($id)
    {
        ...
        $this->lingueRepository->update($data, $id);

        session()->flash('success', trans('admin::app.cinema.lingua.update-success'));
    ...
    public function destroy($id)
    {
        ...
        try {
            $this->lingueRepository->delete($id);
