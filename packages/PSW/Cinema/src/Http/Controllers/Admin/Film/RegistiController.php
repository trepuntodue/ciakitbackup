...
use PSW\Cinema\DataGrids\RegistiDataGrid;
use Webkul\Admin\Http\Controllers\Controller;
use Webkul\Core\Repositories\ChannelRepository;
use Illuminate\Support\Facades\DB;
use PSW\Cinema\Film\Repositories\RegistiRepository;
...
class RegistiController extends Controller
{
     ...
     *
     * @param \PSW\Cinema\Film\Repositories\RegistiRepository  $registiRepository
     */
    public function __construct(
       protected RegistiRepository $registiRepository 
        )
    {
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            return app(RegistiDataGrid::class)->toJson();
        }
    ...
    public function create()
    {
        ...
        $registi = DB::table('registi')->orderBy('registi_nome', 'asc')->get();
       // echo '<pre>';print_r($generi);  
        return view($this->_config['view'], compact('registi'));
    }
    ...
    public function store(Request $req)
    {
       ...
       // echo '<pre>';print_r($data);
        ...
        //die();
        $data['registi_nome_cognome']=$data['registi_nome'].' '.$data['registi_cognome'].' '.$data['registi_alias'];
        if ($this->registiRepository->create($data)) {
            session()->flash('success', trans('admin::app.cinema.regista.create-success'));
           return redirect()->route($this->_config['redirect']);
        }
            session()->flash('error', trans('admin::app.cinema.regista.create-error'));        
    ...
    public function edit($id)
    {
        ...
        $registi=$this->registiRepository->findOneByField('id',$id);
    ...
    public function update($id)
    {
        ...
        $this->registiRepository->update($data, $id);

        session()->flash('success', trans('admin::app.cinema.regista.update-success'));
    ...
    public function destroy($id)
    {
        ...
        try {
            $this->registiRepository->delete($id);
