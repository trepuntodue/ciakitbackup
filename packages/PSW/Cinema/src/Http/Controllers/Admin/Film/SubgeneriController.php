...
use PSW\Cinema\DataGrids\SubgenereDataGrid;
use Webkul\Admin\Http\Controllers\Controller;
use Webkul\Core\Repositories\ChannelRepository;
use Illuminate\Support\Facades\DB;
use PSW\Cinema\Film\Repositories\SubgeneriRepository;

class SubgeneriController extends Controller
{
    /**
     ...
     *
     * @param \PSW\Cinema\Film\Repositories\SubgeneriRepository  $subgeneriRepository
     */
    public function __construct(
       protected SubgeneriRepository $subgeneriRepository 
        )
    {
    ...
    public function index()
    {
        ...
        if (request()->ajax()) {
            return app(SubgenereDataGrid::class)->toJson();
        }
    ...
    public function create()
    {
        ...
        $subgeneri = DB::table('sottogeneri')->orderBy('subge_name', 'asc')->get();
       // echo '<pre>';print_r($generi);  
        return view($this->_config['view'], compact('subgeneri'));
    }
    ...
    public function store(Request $req)
    {
       ...
       // echo '<pre>';print_r($data);
        ...
        //die();
        if ($this->subgeneriRepository->create($data)) {
            session()->flash('success', trans('admin::app.cinema.subgenere.create-success'));
           return redirect()->route($this->_config['redirect']);
        }
            session()->flash('error', trans('admin::app.cinema.subgenere.create-error'));        
    ...
    public function edit($id)
    {
        ...
        $subgeneri=$this->subgeneriRepository->findOneByField('id',$id);
    ...
    public function update($id)
    {
        ...
        $this->subgeneriRepository->update($data, $id);

        session()->flash('success', trans('admin::app.cinema.subgenere.update-success'));
    ...
    public function destroy($id)
    {
        ...
        try {
            $this->subgeneriRepository->delete($id);
