...
@section('content')
    <div class="content">
        <form method="POST" action="{{ route('admin.cinema.attore.store') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
            <div class="page-header">
                ...
                <div class="page-action">
                    <button type="submit" class="btn btn-lg btn-primary">
                        {{ __('admin::app.cinema.attore.save-btn-title') }}
                    </button>
                </div>
            </div>
            ...
            <div class="page-content">
                <div class="form-container">
                    ...
                    {!! view_render_event('bagisto.admin.cinema.attore.create_form_accordian.general.before') !!}

                        <div slot="body">
                            {!! view_render_event('bagisto.admin.cinema.attore.create_form_accordian.general.controls.before') !!}
                            ...
                            <div class="control-group" :class="[errors.has('attori_alias') ? 'has-error' : '']"> <!-- PWS#2-attori -->
                                ...
                                <input type="text" class="control" id="attori_alias" name="attori_alias" value="{{ old('attori_alias') }}" data-vv-as="&quot;{{ __('admin::app.cinema.attore.attori_alias') }}&quot;" v-slugify-target="'slug'"/>
                            ...
                            <div class="control-group" :class="[errors.has('attori_nome') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="attori_nome" name="attori_nome" value="{{ old('attori_nome') }}" data-vv-as="&quot;{{ __('admin::app.cinema.attore.attori_nome') }}&quot;" v-slugify-target="'slug'"/>
                            ...
                            <div class="control-group" :class="[errors.has('attori_cognome') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'"  class="control" id="attori_cognome" name="attori_cognome" value="{{ old('attori_cognome') }}" data-vv-as="&quot;{{ __('admin::app.cinema.attore.attori_cognome') }}&quot;" v-slugify-target="'slug'"/>
