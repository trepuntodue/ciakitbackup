...
@section('content')
    <div class="content">
        <form method="POST" action="{{ route('admin.cinema.genere.store') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
            <div class="page-header">
                ...
                <div class="page-action">
                    <button type="submit" class="btn btn-lg btn-primary">
                        {{ __('admin::app.cinema.genere.save-btn-title') }}
                    </button>
                </div>
            </div>
            ...
            <div class="page-content">
                <div class="form-container">
                    ...
                    {!! view_render_event('bagisto.admin.cinema.genere.create_form_accordian.general.before') !!}

                        <div slot="body">
                            {!! view_render_event('bagisto.admin.cinema.genere.create_form_accordian.general.controls.before') !!}
                            ...
                            <div class="control-group" :class="[errors.has('generi_name') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="generi_name" name="generi_name" value="{{ old('generi_name') }}" data-vv-as="&quot;{{ __('admin::app.cinema.genere.genere_maintitle') }}&quot;" v-slugify-target="'slug'"/>
                            ...
                            <div class="control-group" :class="[errors.has('generi_name_en') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" id="generi_name_en" name="generi_name_en" value="{{ old('generi_name_en') }}" data-vv-as="&quot;{{ __('admin::app.cinema.genere.genere_othertitle') }}&quot;" v-slugify-target="'slug'"/>
