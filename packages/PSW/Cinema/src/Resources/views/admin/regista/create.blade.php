...
@section('page_title')
    {{ __('admin::app.cinema.regista.add-title') }}
@stop

@section('content')
    <div class="content">
        <form method="POST" action="{{ route('admin.cinema.regista.store') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
            <div class="page-header">
                ...
                <div class="page-action">
                    <button type="submit" class="btn btn-lg btn-primary">
                        {{ __('admin::app.cinema.regista.save-btn-title') }}
                    </button>
                </div>
            </div>
            ...
            <div class="page-content">
                <div class="form-container">
                    ...
                    {!! view_render_event('bagisto.admin.cinema.regista.create_form_accordian.general.before') !!}

                        <div slot="body">
                            {!! view_render_event('bagisto.admin.cinema.regista.create_form_accordian.general.controls.before') !!}
                            ...
                            <div class="control-group" :class="[errors.has('registi_nome') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="registi_nome" name="registi_nome" value="{{ old('registi_nome') }}" data-vv-as="&quot;{{ __('admin::app.cinema.regista.registi_nome') }}&quot;" v-slugify-target="'slug'"/>
                            ...
                            <div class="control-group" :class="[errors.has('registi_cognome') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'"  class="control" id="registi_cognome" name="registi_cognome" value="{{ old('registi_cognome') }}" data-vv-as="&quot;{{ __('admin::app.cinema.regista.registi_cognome') }}&quot;" v-slugify-target="'slug'"/>
                            ...
                            <div class="control-group" :class="[errors.has('registi_alias') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" id="registi_alias" name="registi_alias" value="{{ old('registi_alias') }}" data-vv-as="&quot;{{ __('admin::app.cinema.regista.registi_alias') }}&quot;" v-slugify-target="'slug'"/>
