...
@section('page_title')
    {{ __('admin::app.cinema.casaproduzione.add-title') }}
@stop

@section('content')
    <div class="content">
        <form method="POST" action="{{ route('admin.cinema.casaproduzione.store') }}" @submit.prevent="onSubmit" enctype="multipart/form-data">
            <div class="page-header">
                ...
                <div class="page-action">
                    <button type="submit" class="btn btn-lg btn-primary">
                        {{ __('admin::app.cinema.casaproduzione.save-btn-title') }}
                    </button>
                </div>
            </div>
            ...
            <div class="page-content">
                <div class="form-container">
                    ...
                    {!! view_render_event('bagisto.admin.cinema.casaproduzione.create_form_accordian.general.before') !!}

                        <div slot="body">
                            {!! view_render_event('bagisto.admin.cinema.casaproduzione.create_form_accordian.general.controls.before') !!}
                            ...
                            <div class="control-group" :class="[errors.has('casa_nome') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'" class="control" id="casa_nome" name="casa_nome" value="{{ old('casa_nome') }}" data-vv-as="&quot;{{ __('admin::app.cinema.casaproduzione.casa_nome') }}&quot;" v-slugify-target="'slug'"/>
                            ...
                            {{-- <div class="control-group" :class="[errors.has('casaproduzioni_cognome') ? 'has-error' : '']">
                                ...
                                <input type="text" v-validate="'required'"  class="control" id="casaproduzioni_cognome" name="casaproduzioni_cognome" value="{{ old('casaproduzioni_cognome') }}" data-vv-as="&quot;{{ __('admin::app.cinema.casaproduzione.casaproduzioni_cognome') }}&quot;" v-slugify-target="'slug'"/>
                            ...
                            <div class="control-group" :class="[errors.has('casaproduzioni_alias') ? 'has-error' : '']">
                                ...
                                <input type="text" class="control" id="casaproduzioni_alias" name="casaproduzioni_alias" value="{{ old('casaproduzioni_alias') }}" data-vv-as="&quot;{{ __('admin::app.cinema.casaproduzione.casaproduzioni_alias') }}&quot;" v-slugify-target="'slug'"/>
