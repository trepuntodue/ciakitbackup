  ...
  'customer' => [
    ...
    'account' => [
      ...
      'wishlist' => [
        ...
        'empty' => 'Non hai elementi nei tuoi preferiti', // PWS#finale
      ...
      'release' => [
        'index' => [
          ...
          'empty' => 'Non hai elementi nella tua collezione.'
        ],
        'favorites' => [
      ...
      //     'view' => [
      //         'page-tile' => 'Versione #:id',
      //     ],

      // 'delete' => [
      //     'confirmation-message' => 'Sei sicuro di voler eliminare questa Versione?',
      // ],

      // 'delete-all' => [
      //     'title'                => 'Cancella tutto',
      //     'confirmation-message' => 'Sei sicuro di voler eliminare tutte le Versione?',
      // ],
      // ],
    ],
  ],
