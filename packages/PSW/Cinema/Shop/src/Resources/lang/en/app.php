...
return [
  ...
  "common" => [
    ...
    "add_to_collection" => "Aggiungi alla collezione", // PWS#video-poster
    "already_in_collection" => "Già nella tua collezione",
    "seleziona_valore" => "Seleziona un risultato",
  ...
  "customer" => [
    ...
    "account" => [
      ...
      "master" => [
        "create" => [
          "title" => "Aggiungi film",
          "page-title" => "Aggiungi film",
          "limits" => "Dimensione massima del file: 3MB. Numero massimo di file: 3.",
          "success" => "Richiesta inviata con successo",
        ]
      ],
      "release" => [
        "index" => [
          "page-title" => "La tua Collezione",
          "title" => "La tua Collezione",
          "add" => "Aggiungi una versione",
          "add-master" => "Aggiungi film", // PWS#chiusura
          "edit" => "Edit",
          "empty" => "You do not have any saved Versioni here, please try to create it by clicking the add button.",
          "create" => "Create Versioni",
          "delete" => "Delete",
          "make-default" => "Make Default",
          "default" => "Default",
          "contact" => "Contact",
          "confirm-delete" => "Do you really want to delete this Versioni?",
          "default-delete" => "Default Versioni cannot be changed.",
          "enter-password" => "Enter Your Password.",
          "aggiunto_a_collezione" => "Edizione aggiunta alla collezione.", // PWS#prod
        ],

        "create" => [
          "page-title" => "Aggiungi una versione",
          "linked_master" => "Titolo originale", // PWS#finale
          "original_title" => "Titolo edizione",
          "other_title" => "Altri eventuali titoli",
          "release_year" => "Anno di edizione",
          "release_distribution" => "Casa di distribuzione",
          "releasetype" => "Tipo",
          "language" => "Lingua",
          "country" => "Paese di Edizione",
          "select-type" => "Select a region, state or province",
          "city" => "City",
          "postcode" => "Postal Code",
          "phone" => "Phone",
          "submit" => "Salva Versione",
          "success" => "Versione have been successfully added.",
          "error" => "Versione cannot be added.",
          "formato" => "Formato",
          "aspect_ratio" => "Aspect ratio",
          "camera_format" => "Camera format",
          "region_code" => "Region code",
          "tipologia" => "Tipologia",
          "canali_audio" => "Canali audio",
          "subtitles" => "Sottotitoli",
          "durata" => "Durata",
          "contenuti_speciali" => "Contenuti speciali",
          "numero_catalogo" => "Numero catalogo",
          "barcode" => "Barcode",
          "crediti" => "Crediti",
          "release_description" => "Descrizione",
          "poster_tipo" => "Tipo di poster",
          "select_poster_tipo" => "Seleziona un tipo",
          "poster_formato" => "Formato",
          "select_poster_formato" => "seleziona un formato",
          "poster_misure" => "Misure",
          "select_poster_misure" => "Seleziona una misura",
          "illustratore" => "Illustratore",
          "stampatore" => "Stampatore",
          "numero_catalogo_tooltip" => "Il numero di catalogo è il codice alfanumerico che identifica l’edizione. Di solito il codice è riportato sul dorso o sul retro della custodia o sull’etichetta del supporto stesso. Se hai bisogno di maggiori informazioni visita la pagina di Supporto e consulta la nostra guida.", // PWS#chiusura
        ],

        "edit" => [
          "page-title" => "Edit Versioni",
          "original_title" => "Titolo edizione",
          "country" => "Paese di Edizione",
          "other_title" => "Altri titoli",
          "release_year" => "Anno di edizione",
          "release_distribution" => "Casa di distribuzione",
          "releasetype" => "Tipo",
          "language" => "Lingua",
          "submit" => "Aggiorna Versione",
          "success" => "Versione updated successfully.",
          "error" => "Versione cannot be update.",
        ],

        "delete" => [
          "success" => "Versioni successfully deleted",
          "failure" => "Versioni cannot be deleted",
        ...
        "view" => [ // PWS#02-23
          ...
          "related_video" => "Altri film simili",
          "related_poster" => "Altri poster simili",
          "status-pending" => "In approvazione", // PWS#chiusura
          "status-approved" => "Pubblicato", // PWS#chiusura
          "status-refused" => "Rifiutato", // PWS#chiusura
        ],
      ],
      "address" => [
        "index" => [
      ...
      "product" => [
        "index" => [
          "page-title" => "I tuoi prodotti",
          "add" => "Aggiungi prodotto",
          "title" => "I tuoi prodotti",
          "empty" => "Non hai inserito nessun prodotto"
        ],
        "create" => [
          "title" => "Inserisci prodotto",
          "title_choose" => "Scegli un'edizione",
          "page_title" => "Crea prodotto",
          "create_description" => "Scegli un'edizione per cui desideri inserire un prodotto",
          "name"  => "Inserisci un nome",
          "price" => "Inserisci un prezzo",
          "submit" => "Crea prodotto",
          "add_releases" => "Per inserire un prodotto, aggiungi prima una edizione alla tua collezione",
          "success-create" => "Prodotto inserito con successo", // PWS#prod-2
        ]
      ],
  ...
  "mail" => [
    ...
    "customer" => [
      ...
      "registration" => [
        ...
        "summary" =>
          "Your account has now been created successfully and you can login using your email address and password credentials. Upon logging in, you will be able to access other services including reviewing past orders, wishlists and editing your account information.",
        "thanks" => "Thanks!",
      ],
      ...
      "subscription" => [
        ...
        "summary" =>
          "Thanks for putting me into your inbox. It’s been a while since you’ve read " .
          config("app.name") .
