 <?php
    ...
    /**
         * Customer's release routes.
         */
        // Route::get('customers/{id}/releases', [ReleaseController::class, 'index'])->defaults('_config', [
        //     'view' => 'admin::customers.releases.index',
        // ])->name('admin.customer.releases.index');

        // Route::get('customers/{id}/releases/create', [ReleaseController::class, 'create'])->defaults('_config', [
        //     'view' => 'admin::customers.releases.create',
        // ])->name('admin.customer.releases.create');

        // Route::post('customers/{id}/releases/create', [ReleaseController::class, 'store'])->defaults('_config', [
        //     'redirect' => 'admin.customer.releases.index',
        // ])->name('admin.customer.releases.store');

        // Route::get('customers/releases/edit/{id}', [ReleaseController::class, 'edit'])->defaults('_config', [
        //     'view' => 'admin::customers.releases.edit',
        // ])->name('admin.customer.releases.edit');

        // Route::put('customers/releases/edit/{id}', [ReleaseController::class, 'update'])->defaults('_config', [
        //     'redirect' => 'admin.customer.releases.index',
        // ])->name('admin.customer.releases.update');

        // Route::post('customers/releases/delete/{id}', [ReleaseController::class, 'destroy'])->defaults('_config', [
        //     'redirect' => 'admin.customer.releases.index',
        // ])->name('admin.customer.releases.delete');

        // Route::post('customers/{id}/releases', [ReleaseController::class, 'massDestroy'])->defaults('_config', [
        //     'redirect' => 'admin.customer.releases.index',
        // ])->name('admin.customer.releases.massdelete');
