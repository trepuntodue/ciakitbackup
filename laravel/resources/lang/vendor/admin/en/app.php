...
return [
    ...
    'cinema' => [
        'release' => [
            'title'                        => 'Release',
            'add-product-btn-title'        => 'Add Release',
            'id'                           => '#id',
            'general'                      => 'INFORMAZIONI',
            'edit-title'                   => 'Modifica Release',
            'cancel-btn-title'             => 'Cancel',
            'shipment-btn-title'           => 'Ship',
            'invoice-btn-title'            => 'Invoice',
            'original_title'               => 'Titolo Originale Master',
            'other_title'                  => 'Altro titolo',
            'release_year'                 => 'Anno di Edizione',
            'releasetype'                  => 'Tipo di Edizione',
            'release_distribution'         => 'Casa di Distribuzione',
            'country'                      => 'Nazione di Edizione',
            'language'                     => 'Lingua di Edizione',
            'release_featured'             => 'Featured',
            'release_status'               => 'Stato',
            'release_status_pending'       => 'Da approvare', // PWS#13-status
            'release_status_rifiutato'     => 'Rifiutato', // PWS#13-status
            'release_status_approvato'     => 'Approvato', // PWS#13-status
            'master_id'                    => 'Film di riferimento', // PWS#13-film
            ...
            'transactions'                 => 'Transactions',
            'release_vt18'                 => 'Vietato ai minori di 18 anni',
            'update-title'                 =>'EDIT RELEASE',
            'update-btn-title'             =>'AGGIORNA RELEASE',
            'update-success'               =>'RELEASE aggiornato con successo',
            'update-error'                 =>'RELEASE errore aggiornato',
            'images'                       =>'IMMAGINI',
            'image'                        =>'Immagine',
            'remove-image-btn-title'       =>'Rimuovi Immagine',
            'add-image-btn-title'          =>'Aggiungi Immagine',
            'image-size'                   => 'Image resolution should be like 600px X 900px',
            'url-key'                      => 'Url Release',
        ],

        'master' => [
            'title'                     => 'Master',
            'add-title'                 => 'INSERISCI Master',
            'edit-title'                => 'Modifica Master',
            'description-and-images'    => 'IMMAGINI',
            'general'                   => 'INFORMAZIONI',
            'master_maintitle'          => 'TITOLO ORIGINALE ',
            'master_othertitle'         => 'ALTRI TITOLI',
            'master_is_visible'         => 'Attivo',
            'master_year'               => 'ANNO',
            'master_director'           => 'REGISTA',
            'master_actors'             => 'ATTORI',
            'master_scriptwriters'      => 'SCENEGGIATORI',
            'master_musiccomposers'     => 'MUSICHE DI',
            'master_studios'            => 'CASE DI PRODUZIONE',
            'master_type'               => 'TIPO',
            'master_subgenres'          => 'SOTTOGENERI',
            'master_language'           => 'LANGUAGE',
            'master_vt18'               => 'Vietato ai minori di 18 anni',
            'master_bn'                 => 'Bianco/nero', // PWS#13-bn
            'save-btn-title'            => 'Salva Master',
            'master_genres'             => 'GENERI',
            'master_subgenres'          => 'SOTTOGENERI',
            'image-size'                => 'Image resolution should be like 600px X 900px',
            'id'                        =>'ID',
            'country'                   =>'PAESE',
            'master_country'            =>'PAESE',
            'create-success'            =>'Master creato con successo',
            'create-error'              =>'Master errore creazione',
            'delete-success'            =>'Master cancellato con successo',
            'delete-failed'             =>'Errore cancellazione Master',
            'update-title'              =>'EDIT MASTER',
            'update-btn-title'          =>'AGGIORNA MASTER',
            'update-success'            =>'Master aggiornato con successo',
            'update-error'              =>'Master errore aggiornato',
            'images'                    =>'IMMAGINI',
            'image'                     =>'Immagine',
            'remove-image-btn-title'    =>'Rimuovi Immagine',
            'add-image-btn-title'       =>'Aggiungi Immagine',
        ...
        'genere' => [
            'title'                     => 'Generi',
            'add-title'                 => 'INSERISCI Generi',
            'edit-title'                => 'Modifica Generi',
            'description-and-images'    => 'IMMAGINI',
            'general'                   => 'INFORMAZIONI',
            'name'                      => 'Nome IT ',
            'name_en'                   => 'Nome EN',
            ...
            'master_language'           => 'LANGUAGE',
            'master_vt18'               => 'Vietato ai minori di 18 anni',
            'save-btn-title'            => 'Salva Genere',
            'master_genres'             => 'GENERI',
            'master_subgenres'          => 'SOTTOGENERI',
            'image-size'                => 'Image resolution should be like 640px X 640px',
            'id'                        =>'ID',
            'master_country'            =>'PAESE',
            'create-success'            =>'Genere creato con successo',
            'create-error'              =>'Genere errore creazione',
            'delete-success'            =>'Genere cancellato con successo',
            'delete-failed'             =>'Errore cancellazione Genere',
            'update-title'              =>'EDIT GENERE',
            'update-btn-title'          =>'AGGIORNA GENERE',
            'update-success'            =>'Genere aggiornato con successo',
            'update-error'              =>'Genere errore aggiornato',
            'genere_maintitle'          =>'NOME',
            'genere_othertitle'         =>'NOME EN',
    ...
    'subgenere' => [
        'title'                     => 'Sotto-Generi',
        'add-title'                 => 'INSERISCI Sotto-Generi',
        'edit-title'                => 'Modifica Sotto-Generi',
        'description-and-images'    => 'IMMAGINI',
        'general'                   => 'INFORMAZIONI',
        'name'                      => 'Nome IT ',
        'name_en'                   => 'Nome EN',
        ...
        'master_language'           => 'LANGUAGE',
        'master_vt18'               => 'Vietato ai minori di 18 anni',
        'save-btn-title'            => 'Salva Sotto-Genere',
        'master_genres'             => 'SOTTO-GENERI',
        'master_subgenres'          => 'SOTTOGENERI',
        'image-size'                => 'Image resolution should be like 640px X 640px',
        'id'                        =>'ID',
        'master_country'            =>'PAESE',
        'create-success'            =>'Sotto-Genere creato con successo',
        'create-error'              =>'Sotto-Genere errore creazione',
        'delete-success'            =>'Sotto-Genere cancellato con successo',
        'delete-failed'             =>'Errore cancellazione Sotto-Genere',
        'update-title'              =>'EDIT SOTTO-GENERE',
        'update-btn-title'          =>'AGGIORNA SOTTO-GENERE',
        'update-success'            =>'Sotto-Genere aggiornato con successo',
        'update-error'              =>'Sotto-Genere errore aggiornato',
        'subgenere_maintitle'          =>'NOME',
        'subgenere_othertitle'         =>'NOME EN',
        'genere_id'                 =>'Genere ID',
    ...
    'attore' => [
        'title'                     => 'Attori',
        'add-title'                 => 'INSERISCI Attori',
        'edit-title'                => 'Modifica Attori',
        'description-and-images'    => 'IMMAGINI',
        'general'                   => 'INFORMAZIONI',
        'name'                      => 'Nome IT ',
        'name_en'                   => 'Nome EN',
        ...
        'master_language'           => 'LANGUAGE',
        'master_vt18'               => 'Vietato ai minori di 18 anni',
        'save-btn-title'            => 'Salva Attori',
        'image-size'                => 'Image resolution should be like 640px X 640px',
        'id'                        =>'ID',
        'master_country'            =>'PAESE',
        'create-success'            =>'Attori creato con successo',
        'create-error'              =>'Attori errore creazione',
        'delete-success'            =>'Attori cancellato con successo',
        'delete-failed'             =>'Errore cancellazione Attori',
        'update-title'              =>'EDIT Attori',
        'update-btn-title'          =>'AGGIORNA Attori',
        'update-success'            =>'Attori aggiornato con successo',
        'update-error'              =>'Attori errore aggiornato',
        'subgenere_maintitle'          =>'NOME',
        'subgenere_othertitle'         =>'NOME EN',
        'genere_id'                 =>'Genere ID',
        'attori_nome'               =>'Nome',
        'attori_cognome'             =>'Cognome',
        'attori_alias'               =>'Alias',
        'nome'               =>'Nome',
        'cognome'             =>'Cognome',
        'alias'               =>'Alias',
    ...
    'sceneggiatore' => [
        'title'                     => 'Sceneggiatori',
        'add-title'                 => 'INSERISCI Sceneggiatori',
        'edit-title'                => 'Modifica Sceneggiatori',
        'description-and-images'    => 'IMMAGINI',
        'general'                   => 'INFORMAZIONI',
        'name'                      => 'Nome IT ',
        'name_en'                   => 'Nome EN',
        ...
        'master_language'           => 'LANGUAGE',
        'master_vt18'               => 'Vietato ai minori di 18 anni',
        'save-btn-title'            => 'Salva Sceneggiatori',
        'image-size'                => 'Image resolution should be like 640px X 640px',
        'id'                        =>'ID',
        'master_country'            =>'PAESE',
        'create-success'            =>'Sceneggiatori creato con successo',
        'create-error'              =>'Sceneggiatori errore creazione',
        'delete-success'            =>'Sceneggiatori cancellato con successo',
        'delete-failed'             =>'Errore cancellazione Sceneggiatori',
        'update-title'              =>'EDIT Sceneggiatori',
        'update-btn-title'          =>'AGGIORNA Sceneggiatori',
        'update-success'            =>'Sceneggiatori aggiornato con successo',
        'update-error'              =>'Sceneggiatori errore aggiornato',
        'subgenere_maintitle'       =>'NOME',
        'subgenere_othertitle'      =>'NOME EN',
        'genere_id'                 =>'Genere ID',
        'scene_nome'               =>'Nome',
        'scene_cognome'            =>'Cognome',
        'scene_alias'              =>'Alias',
        'nome'                      =>'Nome',
        'cognome'                   =>'Cognome',
        'alias'                     =>'Alias',
    ...
    'regista' => [
        'title'                     => 'Registi',
        'add-title'                 => 'INSERISCI Registi',
        'edit-title'                => 'Modifica Registi',
        'description-and-images'    => 'IMMAGINI',
        'general'                   => 'INFORMAZIONI',
        'name'                      => 'Nome IT ',
        'name_en'                   => 'Nome EN',
        ...
        'master_language'           => 'LANGUAGE',
        'master_vt18'               => 'Vietato ai minori di 18 anni',
        'save-btn-title'            => 'Salva Registi',
        'image-size'                => 'Image resolution should be like 640px X 640px',
        'id'                        =>'ID',
        'master_country'            =>'PAESE',
        'create-success'            =>'Registi creato con successo',
        'create-error'              =>'Registi errore creazione',
        'delete-success'            =>'Registi cancellato con successo',
        'delete-failed'             =>'Errore cancellazione Registi',
        'update-title'              =>'EDIT Registi',
        'update-btn-title'          =>'AGGIORNA Registi',
        'update-success'            =>'Registi aggiornato con successo',
        'update-error'              =>'Registi errore aggiornato',
        'subgenere_maintitle'          =>'NOME',
        'subgenere_othertitle'         =>'NOME EN',
        'genere_id'                 =>'Genere ID',
        'registi_nome'               =>'Nome',
        'registi_cognome'             =>'Cognome',
        'registi_alias'               =>'Alias',
        'nome'               =>'Nome',
        'cognome'             =>'Cognome',
        'alias'               =>'Alias',
    ...
    'compositore' => [
        'title'                     => 'Compositori',
        'add-title'                 => 'INSERISCI Compositori',
        'edit-title'                => 'Modifica Compositori',
        'description-and-images'    => 'IMMAGINI',
        'general'                   => 'INFORMAZIONI',
        'name'                      => 'Nome IT ',
        'name_en'                   => 'Nome EN',
        ...
        'master_language'           => 'LANGUAGE',
        'master_vt18'               => 'Vietato ai minori di 18 anni',
        'save-btn-title'            => 'Salva Compositori',
        'image-size'                => 'Image resolution should be like 640px X 640px',
        'id'                        =>'ID',
        'master_country'            =>'PAESE',
        'create-success'            =>'Compositori creato con successo',
        'create-error'              =>'Compositori errore creazione',
        'delete-success'            =>'Compositori cancellato con successo',
        'delete-failed'             =>'Errore cancellazione Compositori',
        'update-title'              =>'EDIT Compositori',
        'update-btn-title'          =>'AGGIORNA Compositori',
        'update-success'            =>'Compositori aggiornato con successo',
        'update-error'              =>'Compositori errore aggiornato',
        'subgenere_maintitle'       =>'NOME',
        'subgenere_othertitle'      =>'NOME EN',
        'genere_id'                 =>'Genere ID',
        'compo_nome'                =>'Nome',
        'compo_cognome'             =>'Cognome',
        'compo_alias'               =>'Alias',
        'nome'                      =>'Nome',
        'cognome'                   =>'Cognome',
        'alias'                     =>'Alias',
    ...
    'casaproduzione' => [
        'title'                     => 'Casa di Produzione',
        'add-title'                 => 'INSERISCI Casa di Produzione',
        'edit-title'                => 'Modifica Casa di Produzione',
        'description-and-images'    => 'IMMAGINI',
        'general'                   => 'INFORMAZIONI',
        'name'                      => 'Nome IT ',
        'name_en'                   => 'Nome EN',
        ...
        'master_language'           => 'LANGUAGE',
        'master_vt18'               => 'Vietato ai minori di 18 anni',
        'save-btn-title'            => 'Salva Casa di Produzione',
        'image-size'                => 'Image resolution should be like 640px X 640px',
        'id'                        =>'ID',
        'master_country'            =>'PAESE',
        'create-success'            =>'Casa di Produzione creato con successo',
        'create-error'              =>'Casa di Produzione errore creazione',
        'delete-success'            =>'Casa di Produzione cancellato con successo',
        'delete-failed'             =>'Errore cancellazione Casa di Produzione',
        'update-title'              =>'EDIT Casa di Produzione',
        'update-btn-title'          =>'AGGIORNA Casa di Produzione',
        'update-success'            =>'Casa di Produzione aggiornato con successo',
        'update-error'              =>'Casa di Produzione errore aggiornato',
        'subgenere_maintitle'       =>'NOME',
        'subgenere_othertitle'      =>'NOME EN',
        'genere_id'                 =>'Genere ID',
        'casa_nome'                 =>'Nome',
    ...
    'lingua' => [
        'title'                     => 'Lingue',
        'add-title'                 => 'INSERISCI Lingua',
        'edit-title'                => 'Modifica Lingua',
        'description-and-images'    => 'IMMAGINI',
        'general'                   => 'INFORMAZIONI',
        'name'                      => 'Nome IT ',
        'name_en'                   => 'Nome EN',
        ...
        'master_language'           => 'LANGUAGE',
        'master_vt18'               => 'Vietato ai minori di 18 anni',
        'save-btn-title'            => 'Salva Lingua',
        'image-size'                => 'Image resolution should be like 640px X 640px',
        'id'                        =>'ID',
        'master_country'            =>'PAESE',
        'create-success'            =>'Lingue creato con successo',
        'create-error'              =>'Lingue errore creazione',
        'delete-success'            =>'Lingue cancellato con successo',
        'delete-failed'             =>'Errore cancellazione Lingua',
        'update-title'              =>'EDIT Lingua',
        'update-btn-title'          =>'AGGIORNA Lingua',
        'update-success'            =>'Lingue aggiornato con successo',
        'update-error'              =>'Lingue errore aggiornato',
        'subgenere_maintitle'       =>'NOME',
        'subgenere_othertitle'      =>'NOME EN',
        'genere_id'                 =>'Genere ID',
        'name'                      =>'Nome',
    ...
    'customers' => [
        ...
        'release' => [
            ...
            'create-btn-title'    => 'Add Release',
            'save-btn-title'      => 'Save Release',
            'master_id'          => 'Master',
        ],
        'master' => [
            'page-title'  => 'Release',
            ...
            'create-btn-title'    => 'Add Master',
            'save-btn-title'      => 'Save Master',
            'create-success'    => 'Master created successfully.',
            'update-success'    => 'Master updated successfully.',
            'delete-success'    => 'Master deleted successfully.',
        ],
        'subscribers' => [
