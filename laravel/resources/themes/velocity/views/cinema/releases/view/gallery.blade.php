...
{!! view_render_event('bagisto.shop.cinema.release.view.gallery.before', ['releases' => $releases]) !!}
@if($imageData)
    <div class="product-image-group">
        <div class="row col-12">
            <magnify-image src="{{ $imageData[0]['large_image_url'] }}" type="{{ $imageData[0]['type'] }}"></magnify-image>
        </div>
...
@endif
{!! view_render_event('bagisto.shop.cinema.release.view.gallery.after', ['releases' => $releases]) !!}
