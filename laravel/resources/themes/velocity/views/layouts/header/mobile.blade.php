...
<mobile-header is-customer="{{ auth()->guard('customer')->check()? 'true': 'false' }}"
  ...
  <div class="row">
    ...
    <div class="col-8">
      ...
      <a class="left" href="{{ route('shop.home.index') }}" aria-label="Logo">
        <img class="logo aspect-4/3 w-auto" width="200" height="150"
          src="{{ core()->getCurrentChannel()->logo_url ?? asset('themes/velocity/assets/images/ciakit-logo-white.png') }}"
          alt="ciakit" />
      </a>
    ...
    @auth('customer')
      <ul type="none" class="vc-customer-options">
        ...
        <li>
          ...
          <a href="{{ route('customer.release.index') }}" class="unset">
            <i class="icon release text-down-3"></i>
            <span>{{ __('velocity::app.shop.general.release') }}</span>
          </a>
        </li>
  ...
  <template v-slot:logo>
    <img class="logo aspect-4/3 w-auto" width="200" height="150"
      src="{{ core()->getCurrentChannel()->logo_url ?? asset('themes/velocity/assets/images/ciakit-logo-black.png') }}"
      alt="ciakit" />
  </template>
