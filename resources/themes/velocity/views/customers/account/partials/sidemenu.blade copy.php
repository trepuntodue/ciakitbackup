<div class="customer-sidebar row no-margin no-padding">
  <div class="account-details col-12">
    ...
    <div>
      <img style="width:80px;height:80px;border-radius:50%;" src="{{ auth('customer')->user()->image_url }}"
    ...
    <div class="col-12 customer-name-text text-capitalize text-break">{{ auth('customer')->user()->first_name . ' ' .
      auth('customer')->user()->last_name}}</div>
