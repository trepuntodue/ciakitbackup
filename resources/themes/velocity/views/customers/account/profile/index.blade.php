            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="notranslate">{{ $customer->first_name }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="notranslate">{{ $customer->last_name }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="notranslate">{{ __('velocity::app.shop.gender.' . strtolower($customer->gender)) ?? '-' }}</td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="notranslate">@php echo date("d-m-Y", strtotime($customer->date_of_birth)); @endphp</td><!-- PWS#finale -->
                        @else
                        <td class="notranslate">{{ $customer->date_of_birth ?? '-' }}</td>
                        @endif
                    </tr>
                    ...
                    <tr>
                        <td>{{ __('shop::app.customer.account.profile.created_at') }}</td>
                        @if($customer->created_at)
                        <td class="notranslate">@php echo date("d-m-Y", strtotime($customer->created_at)); @endphp</td><!-- PWS#finale -->
                        @else
                        <td class="notranslate">{{ $customer->created_at ?? '-' }}</td>
                        @endif
                    </tr>
