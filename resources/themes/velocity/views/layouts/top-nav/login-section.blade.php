        ...
        <div class="dropdown-list">
            ...
            <div class="dropdown-container">
                <ul type="none">
                    ...
                    <li>
                        <a href="{{ route('customer.release.index') }}" class="unset">{{ __('shop::app.customer.account.release.index.title') }}</a>
                    </li>
                    ...
                    @if ($showWishlist)
                        <li>
                            <a href="{{ route('customer.release.favorites') }}" class="unset">{{ __('shop::app.header.wishlist') }}</a>
                        </li>
                    @endif

                    <li>
                        <a href="{{ route('customer.release.create') }}" class="unset">{{ __('shop::app.customer.account.release.index.add') }}</a>
                    </li>

                    <li>
                        <a href="{{ route('customer.master.create') }}" class="unset">{{ __('shop::app.customer.account.release.index.add-master') }}</a>
                    </li>
