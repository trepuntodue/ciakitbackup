        ...
        <div>
            ...
            <div class="control-group" :class="[errors.has('state') ? 'has-error' : '']">
                <label for="state" class="{{ core()->isStateRequired() ? 'required' : '' }}">
                    {{ __('shop::app.customer.account.release.create.state') }}
                </label>
                ...
                <input
                    ...
                    data-vv-as="&quot;{{ __('shop::app.customer.account.release.create.state') }}&quot;"
                    v-if="! haveStates()"/>
                ...
                <select
                    ...
                    data-vv-as="&quot;{{ __('shop::app.customer.account.release.create.state') }}&quot;"
                    v-if="haveStates()">
                    <option value="">{{ __('shop::app.customer.account.release.create.select-state') }}</option>
