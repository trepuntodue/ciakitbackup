...
@section('page_title')
    {{ __('shop::app.customer.account.release.edit.page-title') }}
@endsection
...
@section('account-content')
    <div class="account-layout">
        ...
        <form id="customer-release-form" method="post" action="{{ route('customer.release.update', $release->id) }}" @submit.prevent="onSubmit">
            ...
            <div class="account-table-content">
                ...
                <div class="control-group" :class="[errors.has('company_name') ? 'has-error' : '']">
                    <label for="company_name">{{ __('shop::app.customer.account.release.edit.company_name') }}</label>

                    <input
                        class="control"
                        type="text"
                        name="company_name"
                        value="{{ old('company_name') ?: $release->company_name }}"
                        data-vv-as="&quot;{{ __('shop::app.customer.account.release.edit.company_name') }}&quot;">
                ...
                {!! view_render_event('bagisto.shop.customers.account.release.edit_form_controls.company_name.after') !!}
                ...
                <div class="control-group" :class="[errors.has('first_name') ? 'has-error' : '']">
                    ...
                    <input
                        ...
                        type="text"
                        name="first_name"
                        value="{{ old('first_name') ?: $release->first_name }}"
                        v-validate="'required'"
                ...
                {!! view_render_event('bagisto.shop.customers.account.release.edit_form_controls.first_name.after') !!}
                ...
                {!! view_render_event('bagisto.shop.customers.account.release.edit_form_controls.last_name.after') !!}
                ...
                <div class="control-group" :class="[errors.has('vat_id') ? 'has-error' : '']">
                    ...
                    <input
                        ...
                        type="text"
                        name="vat_id"
                        value="{{ old('vat_id') ?: $release->vat_id }}"
                        v-validate="''"
                ...
                {!! view_render_event('bagisto.shop.customers.account.release.edit_form_controls.vat_id.after') !!}

                <?php $addresses = explode(PHP_EOL, $release->address1); ?>

                <div class="control-group {{ $errors->has('address1.*') ? 'has-error' : '' }}">
                    <label for="address_0" class="required">{{ __('shop::app.customer.account.release.edit.street-address') }}</label>
                    ...
                    <input
                        ...
                        value="{{ $addresses[0] ?? '' }}"
                        v-validate="'required'"
                        data-vv-as="&quot;{{ __('shop::app.customer.account.release.create.street-address') }}&quot;">
                ...
                {!! view_render_event('bagisto.shop.customers.account.release.edit_form_controls.street-addres.after') !!}

                <div class="control-group" :class="[errors.has('city') ? 'has-error' : '']">
                    <label for="city" class="required">{{ __('shop::app.customer.release.address.create.city') }}</label>
                ...
                <div class="control-group" :class="[errors.has('postcode') ? 'has-error' : '']">
                    ...
                    <input
                        ...
                        value="{{ old('postcode') ?: $release->postcode }}"
